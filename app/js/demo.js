...
$(document).ready(function() {
  $('.hamburguesa').on('click', function() {
    document.getElementById("hamburguesa-menu").style.visibility = "hidden";
    document.getElementById("box-content-info").style.display = "none";
    $('nav').toggleClass('mostrar');
  });

  $('.cruz').on('click', function() {
    $('nav').removeClass('mostrar');
    document.getElementById("hamburguesa-menu").style.visibility = "visible";
    document.getElementById("box-content-info").style.display = "block";
  });
});
/**/
